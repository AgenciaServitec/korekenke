...
(function (root, factory) {
  ...
  var startsWithHandlesInfinity = (function () {
    return (
      String.prototype.startsWith && "abc".startsWith("a", Infinity) === false
    );
  })();
    ...
    from: function from(items) {
      ...
      if (usingIterator !== void 0) {
        ...
        for (i = 0; i < length; ++i) {
          ...
          if (mapping) {
            value =
              T !== undefined ? _call(mapFn, T, value, i) : mapFn(value, i);
          }
          result[i] = value;
        }
      }
  ...
  var arrayFromHandlesIterables = (function () {
    ...
    return (
      arr.length === 1 && isArray(arr[0]) && arr[0][0] === 0 && arr[0][1] === 0
    );
  })();
  ...
  if (Number("0o10") !== 8 || Number("0b10") !== 2) {
    ...
    var NumberShim = (function () {
      ...
      return function Number(value) {
        var primValue = Type.primitive(value)
          ? value
  ...
  if (!regExpSupportsFlagsWithRegex && supportsDescriptors) {
    ...
    var RegExpShim = function RegExp(pattern, flags) {
      ...
      if (
        !calledWithNew &&
        (Type.regex(pattern) || (pattern && pattern.constructor === RegExp))
      ) {
        return pattern;
      }
  ...
  var MathShims = {
    ...
    clz32: function clz32(value) {
      ...
      return numberCLZ
        ? _call(numberCLZ, number)
        : 31 - _floor(_log(number + 0.5) * Math.LOG2E);
    },
  ...
  if (supportsDescriptors) {
    ...
    if (globals.Map || globals.Set) {
      ...
      var mapFailsToSupportSubclassing =
        Object.setPrototypeOf && !mapSupportsSubclassing; // without Object.setPrototypeOf, subclassing is not possible
      ...
      var setFailsToSupportSubclassing =
        Object.setPrototypeOf && !setSupportsSubclassing; // without Object.setPrototypeOf, subclassing is not possible
  ...
  if (
    functionsHaveNames &&
    globals.Reflect.getPrototypeOf.name !== "getPrototypeOf"
  ) {

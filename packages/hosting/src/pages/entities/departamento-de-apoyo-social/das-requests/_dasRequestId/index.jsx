...
const DasRequest = ({ currentStep, onSetCurrentStep }) => {
  const showStep = () => {
    switch (currentStep) {
      case 0:
        return <TypeRequestStep1 onSetCurrentStep={onSetCurrentStep} />;
      case 1:
        return <PersonalInformationStep2 onSetCurrentStep={onSetCurrentStep} />;
      case 2:
  ...
  return <Container>{showStep()}</Container>;
